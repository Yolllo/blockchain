	...
	return factory.ProcessComponentsFactoryArgs{
		...
		SystemSCConfig: &config.SystemSmartContractsConfig{
			...
			GovernanceSystemSCConfig: config.GovernanceSystemSCConfig{
				...
				FirstWhitelistedAddress: "yol19mfd998dpqcdm5m5z5gn7u3lw6jwnxk8w75gh4gzjxcxfvtxmm8q3gd0su",
			},
			...
			DelegationManagerSystemSCConfig: config.DelegationManagerSystemSCConfig{
				...
				MinStakeAmount:      "100",
				ConfigChangeAddress: "yol19mfd998dpqcdm5m5z5gn7u3lw6jwnxk8w75gh4gzjxcxfvtxmm8q3gd0su",
			},
